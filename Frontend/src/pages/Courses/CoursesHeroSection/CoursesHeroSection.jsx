...
export const CoursesHeroSection = () => {
  return (
    <div className="w-full flex justify-between mt-[-20px] lg:mt-6">
      <div className="lg:w-[50%] h-[250px] md:h-[300px] lg:h-[480px]  flex flex-col gap-4 justify-center">
        ...
        <div className="bg-[#fff] w-[80%] md:mt-4 flex h-8  md:h-12 rounded-[6px]">
          ...
          <button className="hidden md:block w-[200px] p-2 bg-secOrange m-1 rounded-[6px] text-[#fff] font-semibold hover:bg-base hover:text-[#fff] transition duration-500">
            Search Courses{" "}
          </button>
          <button className="block md:hidden md:w-[200px] px-6 bg-secOrange m-1 rounded-[6px] font-semibold text-[#fff] text-[12px]  md:text-[16px] hover:bg-base hover:text-[#fff] transition duration-500">
            Search
          </button>
        </div>
      </div>
