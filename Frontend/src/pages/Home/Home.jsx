      ...
      <div className="bg-gray ">
        <div className="py-4 md:py-8 max-w-[1500px] m-auto">
          <Marquee>
            ...
            >
              MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER MEDCOVER
            </h2>
          </Marquee>
        </div>
      </div>
